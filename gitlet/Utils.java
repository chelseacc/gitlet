...
class Utils {
    ...
    /** Returns an OBJ by finding FILENAME and deserializing its content. */
    static Object deserialize(File filename) {
        Object o = new Object();
        try {
            FileInputStream bi = new FileInputStream(filename);
